...
public class Email : IEmail
{
    ...
    public Email()
    {
        ...
        _username = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "crystal.skin.app@gmail.com";
        _password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "drbg yllp edtx cxhz";
        _displayName = Environment.GetEnvironmentVariable("MAIL_DISPLAY_NAME") ?? "crystal_skin.ba";
        _fromAddress = Environment.GetEnvironmentVariable("MAIL_FROM_ADDRESS") ?? "no-replay@crystal_skin.ba";
    }
