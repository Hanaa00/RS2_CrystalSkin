...
{
    public ProductCategoriesService(IMapper mapper, IValidator<ProductCategoryUpsertModel> validator, DatabaseContext databaseContext) : base(mapper, validator, databaseContext)
    {
        //
    }
