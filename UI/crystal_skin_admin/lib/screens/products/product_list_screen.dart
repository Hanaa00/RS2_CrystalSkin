import 'package:crystal_skin_admin/screens/products/product_add_screen.dart';
import 'package:crystal_skin_admin/screens/products/product_edit_screen.dart';
import 'package:flutter/material.dart';
import 'package:crystal_skin_admin/models/product.dart';
import 'package:crystal_skin_admin/providers/products_provider.dart';
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Widget _buildDefaultProductImage() {
    return const Center(
      child: Icon(Icons.shopping_bag_outlined, size: 60, color: Colors.teal),
    );
  }
