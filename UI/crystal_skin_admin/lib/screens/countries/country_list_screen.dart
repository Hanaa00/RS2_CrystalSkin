import 'package:crystal_skin_admin/models/country.dart';
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon:
                          const Icon(Icons.short_text, color: Colors.teal),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10),
                            borderSide: BorderSide(color: Colors.grey.shade300),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              if (_nameController.text.isEmpty || _abrvController.text.isEmpty) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text("Popunite sva obavezna polja"),
                                    backgroundColor: Colors.red,
                                    behavior: SnackBarBehavior.floating,
                              ...
                              try {
                                ...
                                if (isEdit) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text("Država uspješno izmijenjena"),
